...
const environmentSchema = z.object({
  ...
  USERS_PORT: z.coerce.number().int().positive().default(3002),
  USERS_HOST: z.string().default('0.0.0.0'),
  JWT_ACCESS_SECRET: z.string().min(16).default('local-dev-jwt-access-secret'),
  JWT_ACCESS_EXPIRES_IN_SECONDS: z.coerce.number().int().positive().default(2_592_000),
